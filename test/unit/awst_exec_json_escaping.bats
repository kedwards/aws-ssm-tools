...
@test "awst_exec escapes double quotes in JSON payload" {
...
@test "awst_exec escapes single quotes in JSON payload" {
...
@test "awst_exec escapes backslashes in JSON payload" {
...
@test "awst_exec escapes newlines in JSON payload" {
...
@test "awst_exec escapes dollar signs in JSON payload" {
...
@test "awst_exec formats simple command into JSON payload" {
...
@test "awst_exec formats command with arguments into JSON payload" {
...
@test "awst_exec formats command with pipes into JSON payload" {
...
@test "awst_exec escapes complex command with multiple special characters" {
